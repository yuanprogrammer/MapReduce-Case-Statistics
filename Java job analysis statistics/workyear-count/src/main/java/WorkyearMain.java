...
public class WorkyearMain {
    public static void main(String[] args) {
        try {
            ...
            Job job = Job.getInstance(conf, "WorkyearMain");//创建一个job作业
            job.setJarByClass(WorkyearMain.class);//设置入口类
            ...
            System.out.println("\t" + new SimpleDateFormat("yyyy-MM-dd hh:mm:ss").format(new Date()) + (result ? "工作经验要求（Java-Job）统计完毕！！！" : "统计失败！！！"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
