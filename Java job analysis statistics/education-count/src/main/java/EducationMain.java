...
public class EducationMain {
    public static void main(String[] args) {
        try {
            ...
            Job job = Job.getInstance(conf, "EducationMain");//创建一个job作业
            job.setJarByClass(EducationMain.class);//设置入口类
            ...
            System.out.println("\t"+new SimpleDateFormat("yyyy-MM-dd hh:mm:ss").format(new Date()) + (result ? "学历要求（Java-Job）统计完毕！！！" : "统计失败！！！"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
