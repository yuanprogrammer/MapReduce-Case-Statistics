...
/**
 * FileName:    SkillLabelMain
 * Author:      Yuan-Programmer
 * Date:        2022/1/2 10:43
 * Description:
 */
public class SkillLabelMain {
    public static void main(String[] args) {
        try {
            ...
            Job job = Job.getInstance(conf, "SkillLabelMain");//创建一个job作业
            job.setJarByClass(SkillLabelMain.class);//设置入口类
            ...
            System.out.println("\t"+new SimpleDateFormat("yyyy-MM-dd hh:mm:ss").format(new Date()) + (result ? "技能标签（Java-Job）统计排序完毕！！！" : "统计失败！！！"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
