...
public class UniversityMain {
    public static void main(String[] args) {
        try {
            ...
            // 指定v2的输出数据类型
            job.setMapOutputValueClass(UniversityInfo.class);
            // Reduce
//            job.setNumReduceTasks(0);
            ...
            System.out.println(new SimpleDateFormat("yyyy-MM-dd hh:mm:ss").format(new Date()) + (result ? "星级排名（university）统计排序完毕！！！" : "统计失败！！！"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
